...
window.DT_RULES_TEXT = [
  ...
  "Scoring now mirrors the official Fantasy Premier League game's rules exactly, including their current defensive contribution bonus.",
  ...
  "Defenders: +2 for 10 or more combined clearances, blocks, interceptions and tackles in a match. Goalkeepers are not eligible for this bonus.",
  "Midfielders and forwards: +2 for 12 or more combined clearances, blocks, interceptions, tackles and recoveries in a match.",
  "Goals: goalkeeper +6, defender +6, midfielder +5, forward +4. Assists: +3 for any position.",
  "Clean sheets (no goals conceded, 60+ mins played): goalkeeper and defender +4, midfielder +1, forward none.",
  "Goalkeepers and defenders lose 1 point for every 2 goals conceded in a match.",
